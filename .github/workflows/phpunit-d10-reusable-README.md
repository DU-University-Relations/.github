...
A reusable GitHub Actions workflow for running PHPUnit tests against Drupal 10 modules. This workflow sets up PHP and Composer dependencies, installs your module into the Drupal upstream, and runs PHPUnit tests with configurable test paths and PHPUnit configuration.
